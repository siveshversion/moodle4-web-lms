...
$objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('C1', 'Subcategory')
            ->setCellValue('D1', 'Course Full Name')
			->setCellValue('E1', 'Course Short Name')
			->setCellValue('F1', 'Topic Name')
			->setCellValue('G1', 'Course Level')
			->setCellValue('H1', 'Course Type')
			->setCellValue('I1', 'Points')
			->setCellValue('J1', 'Duration')
			->setCellValue('K1', 'Course Summary')
			->setCellValue('L1', 'Tags');
...
$objPHPExcel->setActiveSheetIndex(0)
		->setCellValue('A'.$row, $s)
            ...
            ->setCellValue('E'.$row, $categorytype->shortname)
			->setCellValue('F'.$row, $ff)
			->setCellValue('G'.$row, $vLevel)
			->setCellValue('H'.$row, $cts->coursetype)
			->setCellValue('I'.$row, $categorytype->points)			
			->setCellValue('J'.$row, $vDuration)
			->setCellValue('K'.$row, strip_tags($summary))
			->setCellValue('L'.$row, '');
